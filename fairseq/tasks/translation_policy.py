...
from fairseq.data import (
    ...
    IndexedRawTextDataset, IndexedCachedDataset, IndexedDataset, LanguagePairSelfDatasetPolicy
)

from . import FairseqTask, register_task


@register_task('translation_policy')
class TranslationPolicyTask(FairseqTask):
    """
    ...
    def load_dataset(self, split, combine=False, epoch=0):
        ...
        self.datasets[split] = LanguagePairSelfDatasetPolicy(
